        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!textBox1.Text.Equals(string.Empty))
                {
                    ...
                    Properties.Settings.Default["Bibliothèque"] = "Data Source=" +src +";Initial Catalog=Bibliothèque;Integrated Security=SSPI";
                    SqlConnection con = new SqlConnection(Properties.Settings.Default.Bibliothèque);
